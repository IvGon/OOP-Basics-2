...
spr_route = []                                              # Справочник маршрутов
spr_train = []                                              # Справочник поездов
park_wagon = []                                             # Подвижной состав
...
spr_train.each do |train|    
  ...
  print (train.train_number.ljust  7) + (train.to_s.ljust 27) + (train.route.to_s.ljust 27)
...
# --------------------- Формирование справочников стаций, маршрутов, поездов --------------------------------- 
  ...
  when "tr ls"              # справочник поездов
    ...
    spr_train.each { |train| print "#{ (train.train_number.center 7)} "\
                                    ...
                                    "#{ (train.num_of_cars.to_s.center 7) }\n"}
    puts
